...
// //             if(comparedetails)
// //             {
// //                 const token=jwt.sign({usermail:logindetails.email},secretkey,{expiresIn:'360000'});
...
// //         }
// //         else{
// //             return res.send({msg:"first you need to register or check your credentials "})
// //         }
// //     }
// //     catch(error){
...
// //             if(userinfo){
// //                 res.send({msg:"User Autherized",userdata:userinfo})
...
// //         }
// //         catch(error){
// //             console.log("Error fetching user detail from db:",error);
// //         }
// //     }
...
// //     const dbres=await DocumentType.find({})
...
//             const userinfo = await reg.findOne({ email: user.useremail });
//             if (userinfo) {
//                return res.send({ msg: "User Authorized", userdata: userinfo })
//             }
//             else {
